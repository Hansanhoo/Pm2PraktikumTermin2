package de.hawhh.informatik.sml.services;
...
import de.hawhh.informatik.sml.werkzeuge.AbstractObservableService;
		...
		implements VerleihService
{
	 ...
	 * Protokolliere
	 */
	private VerleihProtokollierer _protokolliere;
			...
			List<Verleihkarte> initialBestand)
	{
		...
		_protokolliere = new VerleihProtokollierer();
	}
			...
			throws ProtokollierException
	{
		...
		for (Medium medium : medien)
		{
			...
			_protokolliere.protokolliere(VerleihEreignis.Rückgabe,
					_verleihkarten.get(medium));

			// JOptionPane.showMessageDialog(null, "Protokollieren beim
			// Zürucknehmen nicht möglich! Bitte überprüfen Sie Ihre Zieldatei
			// auf Schreibschutz! \n" + e.getMessage() , "Fehlermeldung",
			...
			throws ProtokollierException
	{
		...
		for (Medium medium : medien)
		{
			...
			_protokolliere.protokolliere(VerleihEreignis.Verliehen,
					verleihkarte);
