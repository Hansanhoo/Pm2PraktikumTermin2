package de.hawhh.informatik.sml.werkzeuge.rueckgabe;
...
public class RueckgabeWerkzeug {
	...
	private void registriereRuecknahmeAktion() {
		_rueckgabeUI.getRuecknahmeButton().setOnAction(event -> {
			...
			{
				JOptionPane.showMessageDialog(null, "Protokollieren beim Zürucknehmen nicht möglich! Bitte überprüfen Sie Ihre Zieldatei auf Schreibschutz! \n" + e.getMessage()   , "Fehlermeldung", JOptionPane.ERROR_MESSAGE); 
