package de.hawhh.informatik.sml.werkzeuge.ausleihe;

import java.util.List;

import javax.swing.JOptionPane;

import de.hawhh.informatik.sml.exceptions.ProtokollierException;
...
import de.hawhh.informatik.sml.services.KundenstammService;
import de.hawhh.informatik.sml.services.MedienbestandService;
import de.hawhh.informatik.sml.services.VerleihService;
import de.hawhh.informatik.sml.werkzeuge.ServiceObserver;
import de.hawhh.informatik.sml.werkzeuge.SubWerkzeugObserver;
import de.hawhh.informatik.sml.werkzeuge.kunden.KundenDetailAnzeigerWerkzeug;
import de.hawhh.informatik.sml.werkzeuge.kunden.KundenauflisterWerkzeug;
import de.hawhh.informatik.sml.werkzeuge.medien.MedienDetailAnzeigerWerkzeug;
    ...
    private void registriereAusleihAktion()
    {
        _ausleiheUI.getAusleihButton()
                .setOnAction(event -> {
					...
					{
						JOptionPane.showMessageDialog(null, "Protokollieren beim Ausleihen nicht möglich! Bitte überprüfen Sie Ihre Zieldatei auf Schreibschutz! \n" + e.getMessage()   , "Fehlermeldung", JOptionPane.ERROR_MESSAGE); 
					}
				});
